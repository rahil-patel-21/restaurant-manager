...
Future<Setting> initSettings() async {
  ...
  try {
    ...
    } else if (response.statusCode == 555 && response.headers.containsValue('application/json')){

      AwesomeDialog(
        context: navigatorKey.currentContext,
        headerAnimationLoop: false,
        dialogType: DialogType.ERROR,
        title: "Error code:555",
        desc: "You are not allowed to access data on this server.",
